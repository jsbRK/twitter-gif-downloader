...
(function () {
    ...
    async function convertVideoToGif(videoUrl) {
        ...
        // Step 2: Load video and capture frames, then encode with gif.js
        updateProgress(18);
        return new Promise((resolve, reject) => {
            ...
            video.addEventListener('loadeddata', () => {
                ...
                const gif = new GIF({
                    ...
                    quality: 2,       // 1=best, 20=fast. 2 is excellent quality
                    width: w,
                    height: h,
                    workerScript: './assets/js/gif.worker.js',
                    dither: 'FloydSteinberg',  // Enable dithering for smooth gradients
                ...
                gif.on('progress', (p) => {
                    // Encoding progress: map from 80% to 98%
                    updateProgress(80 + Math.round(p * 18));
                });
                ...
                video.addEventListener('seeked', function onSeeked() {
                    ...
                    // Add frame directly from canvas (gif.js reads pixel data internally)
                    gif.addFrame(ctx, { copy: true, delay: frameDelay });
                    captured++;
                    updateProgress(20 + Math.round((captured / frameCount) * 56));
                    captureFrame();
                });
